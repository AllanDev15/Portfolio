import { calcPreviewAutoscroll } from './projects.js';
...
createProjectModal('gdlwebcamp');

function createProjectModal(projectName) {
  const projectObj = projectsObj.filter((project) => project.name === projectName);
  console.log(projectObj);

  /*  const projectContainer = document.createElement('article');
  projectContainer.className = 'project container container--modal';
  ...
  projectObj.technologies.forEach((technology) => {
    ...
    tool.textContent = technology.name;
